...
class MalEncoder(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv = nn.Sequential(
            nn.Conv1d(in_channels=self.embedding_dim, out_channels=self.conv_dim, kernel_size=512, stride=128),
            nn.BatchNorm1d(self.conv_dim),
            nn.LeakyReLU(inplace=True),
            # nn.Conv1d(in_channels=self.conv_dim, out_channels=self.conv_dim, kernel_size=512, stride=1),
            # nn.BatchNorm1d(self.conv_dim),
            # nn.LeakyReLU(inplace=True),
        ...
        self.classifier = nn.Sequential(
            nn.Linear(self.conv_dim*self.pool_size, self.conv_dim // 2),
