...
if __name__ == '__main__':
    ...
    for root, dirs, files in os.walk(test_dir):
        for file in tqdm(files):
            ...
            # 保存成json文件
            with open("/home/fhh/ember-master/MalConv2-main/tools/activation_28.json", "w") as f:
                for i in range(0,len(upsampled_activation),500):
                    hex_address = hex(i + 1024)
                    f.write(f'{hex_address}:{upsampled_activation[i]}\n')                
